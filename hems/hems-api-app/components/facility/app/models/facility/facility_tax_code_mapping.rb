# == Schema Information
#
# Table name: facility_tax_code_mapping
#
...
#  tax_code               :#<ActiveModel::T not null
...
# Indexes
#
#  facility_tax_code_mapping_index  (facility_code,item_tax_category_code,establishment_id,corporate_id) UNIQUE
#

require_dependency "core/e_d_b_record"

module Facility
	class FacilityTaxCodeMapping < Core::EDBRecord
		def upcase_attrs
	  		["corporate_id","establishment_id","facility_code","item_tax_category_code","tax_code",
