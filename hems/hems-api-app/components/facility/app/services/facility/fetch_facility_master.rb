module Facility
	class FetchFacilityMaster < Core::BaseService
		...
		def process()
			obj=FacilityMaster.where(id: @id, corporate_id: @context.corporate_id, establishment_id: @context.establishment_id).first
