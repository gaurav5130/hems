module Facility
	class FetchFacilityItem < Core::BaseService
		...
		def process()
			obj=FacilityItemMapping.where(id: @id, corporate_id: @context.corporate_id, establishment_id: @context.establishment_id).first
