module Facility
	class FetchFacilityTaxCode < Core::BaseService
		...
		def process()
			obj=FacilityTaxCodeMapping.where(id: @id, corporate_id: @context.corporate_id, establishment_id: @context.establishment_id).first
