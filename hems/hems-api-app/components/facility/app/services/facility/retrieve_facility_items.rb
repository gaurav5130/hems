module Facility
	class RetrieveFacilityItems < Core::BaseService
		...
		def process()
			obj=FacilityItemMapping.all.where(corporate_id: @context.corporate_id, establishment_id: @context.establishment_id)
