module TaxCharge
	class FetchTaxChargeComponent< Core::BaseService
		...
		def process()
			obj=TaxChargeComponentMaster.where(id: @id, corporate_id: @context.corporate_id, establishment_id: @context.establishment_id).first
