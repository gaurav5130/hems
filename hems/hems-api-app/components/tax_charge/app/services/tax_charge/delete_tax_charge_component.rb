module TaxCharge
	class DeleteTaxChargeComponent < Core::BaseService
		...
		def process()
			obj=TaxChargeComponentMaster.where(id: @id, corporate_id: @context.corporate_id, establishment_id: @context.establishment_id).delete_all
