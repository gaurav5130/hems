module TaxCharge
	class RetrieveTaxChargeComponents< Core::BaseService
		...
		def process()
			obj=TaxChargeComponentMaster.all.where(corporate_id: @context.corporate_id, establishment_id: @context.establishment_id)
