...
class BillEhoMigrationGenerator < ActiveRecord::Generators::MigrationGenerator
  ...
  def create_migration_file
    ...
    set_local_assigns!
    validate_file_name!
    migration_template @migration_template, "components/bill/db_eho/migrate/#{file_name}.rb"
  end
end