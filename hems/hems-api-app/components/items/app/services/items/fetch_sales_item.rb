module Items
	class FetchSalesItem	< Core::BaseService
		...
		def process()
			obj=SalesItemDetail.where(id: @id, corporate_id: @context.corporate_id, establishment_id: @context.establishment_id).first
